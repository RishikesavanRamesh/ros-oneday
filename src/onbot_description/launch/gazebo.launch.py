...
#         pkg_share = launch_ros.substitutions.FindPackageShare(package='onbot_description').find('onbot_description')
...
def generate_launch_description():
  ...
  package_name_description = 'onbot_description'
  package_name_gazebo = 'onbot_description'
 
  default_robot_name = 'onbot'
  gazebo_launch_file_path = 'launch'
  gazebo_models_path = 'models'
  ros_gz_bridge_config_file_path = 'config/ros_gz_bridge.yaml'
  rviz_config_file_path = 'rviz/display.rviz'
  urdf_file_path = 'model/robot.urdf'
